...
const double h = 3.0e-3, t1 = 1000000; //Time from t to t1 with h step
...
struct Pendulum{
    ...
    void idle(){
        ...
        if(menuchoice == 2 || menuchoice == 3){ run_RK4(); display_phasespace(menuchoice); }
